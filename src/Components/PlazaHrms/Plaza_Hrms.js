...
import './Plaza_Hrms.css'
import img1 from '../Assets/Logo-White.png';
import img2 from '../Assets/Background-Image.png';
...
import finance from '../Assets/Finance-Solution.png';
import business from '../Assets/Business-Analysis.png';
...
import saleing from '../Assets/Selling-Easier.png';
...
const Plaza_Hrms = () => {
  return (
    ...
    <img style={{height:800, width: 1508}} src={img2} />
    </div >
...
<div style={{backgroundColor:'lightyellow', marginTop:100,textAlign:'center',width:1508,height:50}}>
